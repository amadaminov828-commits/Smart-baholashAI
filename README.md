...
#### 🗺️ Roadmap
* [x] **Document OCR & Parsing**: Auto-extract details from scanned documents, images, and PDFs.
* [x] **Automated Template Ingestion**: Fill Word (`.docx`) report templates and convert them to PDF.
* [ ] **Payment Gateways**: Integrate local payment systems (Payme, Click, etc.).
* [ ] **Mobile Application**: Build Android & iOS mobile clients.
...
* [x] **OCR и парсинг документов**: Автоматическое извлечение данных из отсканированных документов, изображений и PDF.
* [x] **Автоматическое заполнение шаблонов**: Заполнение шаблонов отчетов Word (`.docx`) и конвертация в PDF.
* [ ] **Платежные шлюзы**: Интеграция локальных платежных систем (Payme, Click и др.).
* [ ] **Мобильное приложение**: Создание мобильных клиентов под Android и iOS.
